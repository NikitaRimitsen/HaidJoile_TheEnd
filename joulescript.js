...
function pallid2(event){
    ...
    pall5.strokeStyle = "#FFA500";//#A52A2A
    pall5.fillStyle="#FFA500";
    pall5.beginPath();
    pall5.arc(160, 530, 10, 0, 2*Math.PI, true);//x, y, R, arc-dug4
    pall5.fill();
    pall5.stroke();

    pall6.strokeStyle = "#A52A2A";
    pall6.fillStyle="#A52A2A";
    pall6.beginPath();
    pall6.arc(230, 460, 10, 0, 2*Math.PI, true);//x, y, R, arc-dug4
    pall6.fill();
    pall6.stroke();
